...
//    }
//    else{
//        double temp1 = (2 * quaternion(1) * quaternion(3)) - (2 * quaternion(0) * quaternion(2));
//        double temp2 = sqx - sqy - sqz + sqw;
//
//        heading = atan2(temp1, temp2);
//        attitude = asin(2 * test/unit);
//
//        double temp3 = (2 * quaternion(0) * quaternion(3)) - (2 * quaternion(1) * quaternion(2));
//        double temp4 = -sqx - sqy -sqz + sqw;
//
//        bank = atan2(temp3, temp4);
//
//    }
//
//    eulAngles(0) = heading;
//    eulAngles(1) = attitude;
//    eulAngles(2) = bank;
